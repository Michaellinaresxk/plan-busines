  ...
  <div class="reservation-list-container">
    <header class="reservation-header">
      ...
      <div class="controls">
        <div class="search-container" :class="{ 'is-focused': isSearchFocused }">
          ...
          <input class="search-input" type="text" placeholder="Search reservations..." v-model="search"
        ...
        <div class="filter-container" ref="filterRef">
          <button class="filter-button" :class="{ 'is-active': isFilterOpen }" @click="toggleFilter"
          ...
          <tr>
            <th v-for="header in tableHeaders" :key="header.key" :style="{ width: header.width }">
              <div class="th-content">
                ...
                <button v-if="header.sortable" class="sort-button"
        ...
        <tbody>
          <tr v-for="item in displayedReservations" :key="item.id" class="table-row">
            ...
            <td class="priority-cell">
              <span class="priority-indicator" :class="item.isPriority ? 'is-priority' : 'is-normal'">
            ...
            <td class="actions-cell">
              <div class="actions-content">
                <button class="action-button approve" :disabled="approvingId === item.id"
                  @click="approveReservation(item)" aria-label="Approve reservation">
    ...
    <div class="pagination-container" v-if="filteredReservations.length > 0">
      <div class="pagination-info">
        <span>Showing {{ paginationStart }} - {{ paginationEnd }} of
      ...
      <div class="pagination-controls">
        ...
        <div class="pagination-pages">
          <button v-for="pageNum in displayedPages" :key="pageNum" class="pagination-page"
...
async function approveReservation(item): Promise<void> {
...
async function rejectReservation(item): Promise<void> {
...
function viewDetails(item): void {
