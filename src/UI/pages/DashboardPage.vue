    ...
    <v-main class="main-content">
      ...
      <v-container fluid class="py-6 px-4 position-relative">
        ...
        <v-row class="content-grid">
          ...
          <v-col cols="12" lg="4">
            <!-- Performance Widget -->
            <div class="glass-card performance-widget mb-6">
              <div class="card-header">
                <div class="card-title">
                ...
                <div class="performance-metrics">
                  <div class="performance-item">
                    <div class="performance-label">
                      ...
                      <v-icon icon="mdi-help-circle" size="14" class="help-icon"></v-icon>
                    </div>
                    <div class="performance-value">
                      <span class="value">{{ monthStats.conversionRate }}%</span>
                  ...
                  <div class="performance-item">
                    ...
                    <div class="performance-value">
                      <span class="value">{{ monthStats.avgResponseTime }}</span>
                      <span class="change negative">+0.3h</span>
                    </div>
                    <div class="performance-bar">
                      <v-progress-linear
                        :model-value="75"
