    ...
    <div class="px-3">
      ...
      <v-list nav class="nav-list">
        ...
        <v-list-item prepend-icon="mdi-calendar-clock" title="Pendientes" value="pending"
          :active="activeItem === 'pending'" color="primary" @click="setActiveItem('pending')" :badge="pendingCount"
          badge-color="error" rounded="lg" class="list-item mb-1"
          :class="{ 'active-item': activeItem === 'pending' }"></v-list-item>

        <v-list-item prepend-icon="mdi-calendar-check" title="Aprobadas" value="approved"
          :active="activeItem === 'approved'" color="primary" @click="setActiveItem('approved')" rounded="lg"
          class="list-item mb-1" :class="{ 'active-item': activeItem === 'approved' }"></v-list-item>
