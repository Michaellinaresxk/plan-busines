      ...
      <div class="calendar-container">
        ...
        >
          ...
          <div
            ...
            v-if="day.currentMonth && day.events && day.events.length > 0"
          >
            <div
...
<script setup lang="ts">
  ...
  import type { CalendarDay, CalendarEvent } from '@/types/reservation';
  ...
  const eventData = ref<CalendarEvent[]>(MOCK_CALENDAR_EVENTS);
